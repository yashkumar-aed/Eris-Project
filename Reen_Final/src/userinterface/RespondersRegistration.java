...
public class RespondersRegistration extends javax.swing.JPanel {
     ...
     */
     public RespondersDirectory responderzzDirectory;
    public Responders respondrd;
    ...
    public RespondersRegistration(JPanel userProcessContainer, EcoSystem system) {
        
        initComponents();
       
        this.userProcessContainer = userProcessContainer;
        this.system = system;
        this.respondrd = new Responders(); 
        populateComboBox();
    }
  ...
  private void populateComboBox() {
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
       ...
       try {
            ...
            ReenEnterprise hospital = (ReenEnterprise) CityJComboBox.getSelectedItem();
            if (hospital == null){
                JOptionPane.showMessageDialog(null, "Please select Reen Foundation Branch");
            ...
            for (Organization o1 : hospital.getOrganizationDirectory().getOrganizationList()){
                   ...
                   if(c1.getName().equals(null) || c1.equals(null)){
                       JOptionPane.showMessageDialog(null, "No Claims Managers available at this branch, Please select another branch!");
            ...
            for (Enterprise e : n.getEnterpriseDirectory().getEnterpriseList()){
               ...
               respondrd.setEmailId(emailId);
            respondrd.setBranch(hospital.getName());
            respondrd.setPassword(password);
            respondrd.setUsername(username);
            respondrd.setFirstName(name);
            JOptionPane.showMessageDialog(null, "Responder Profile Created!");
        //Initiating work request for BMC
             RespondersToClaimsManager bmc = new RespondersToClaimsManager(respondrd);
            ...
            try {
                ...
                for (Organization o : hospital.getOrganizationDirectory().getOrganizationList()){
                   ...
                   respondrd.setClaimsmanagr(c.getName());
                   o.getResponderDirectory().addResponder(respondrd);
                   }
                }
            bmc.setClaimmanagr(c);
            bmc.setStatus("Pending");
            WorkQueue wq = hospital.getWorkQueue();
        
            wq.addRespondersToClaims(bmc);
            ...
            confirmPassTxt.setText("");
                ...
                JOptionPane.showMessageDialog(this, "No Claims Managers available at this branch, Please select another branch!");
