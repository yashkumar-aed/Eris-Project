...
public class ClaimsRequest extends javax.swing.JPanel {
    ...
    public ClaimsRequest(UserAccount userAccount, JPanel userProcessContainer, EcoSystem system) {
        initComponents();
        this.userAccount = userAccount;
        
        this.responn = userAccount.getResponder();
        this.userProcessContainer = userProcessContainer;
        this.system = system;
        
        txtFirstName.setText(responn.getFirstName());
        txtLastName.setText(responn.getLastName());
        txtAffiliations.setText(responn.getAddress());
        txtEmail.setText(responn.getEmailId());
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if(funds > this.responn.getNetFunding()){
            
            JOptionPane.showMessageDialog(null, "Amount need to less or equal to net funding. Net funding :" + responn.getNetFunding());
            return;
        }
     ...
     responn.setClaimsRequestAmount(funds);
        loan.setReen(userAccount.getResponder().getBranch());
        ResponderToClaims respondertocla = new ResponderToClaims("Create new Loan", loan, userAccount.getResponder());
        respondertocla.setStatus("Pending");
        respondertocla.setSender(userAccount);
        respondertocla.setRequestDate(new Date());
        responn.setTypeL(1);
        
        enterprise.getWorkQueue().getResponderToClaim().add(respondertocla);
