...
public class ViewClaimsRequest extends javax.swing.JPanel {
   ...
   private UserAccount userAccount;
    ...
    private ResponderToClaims bl;
    
 public ViewClaimsRequest(JPanel userProcessContainer,UserAccount userAccount, ResponderToClaims bl, Enterprise enterprise) {
        initComponents();
        ...
        txtAffiliation.setText(bl.getLoan().getAddress());
        txtFunds.setText(String.valueOf(bl.getLoan().getFunds()));
        txtPassport.setText(bl.getLoan().getPassportNumber());
        txtAccountNumber.setText(String.valueOf(bl.getLoan().getClaimsAccountNumber()));
    ...
    private void btnApproveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveActionPerformed
          int accNumber = bl.getLoan().getClaimsAccountNumber();
        for (Claims l : enterprise.getClaimDirectory().getLoanAccountList()){
            if(accNumber == (l.getClaimsAccountNumber()))
            {
            l.setFundsApproved(Integer.valueOf(txtApprovedAmount.getText()));
            bl.setStatus("Completed");
            bl.getResponder().setClaimsAmountApproved(Integer.valueOf(txtApprovedAmount.getText()));
            bl.getResponder().setBankBalance(bl.getResponder().getBankBalance()+bl.getResponder().getClaimsAmountApproved());
