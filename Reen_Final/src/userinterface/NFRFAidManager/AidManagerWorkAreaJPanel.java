...
public class AidManagerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public AidManagerWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, EcoSystem system, Enterprise enterprise) {
        initComponents();
    ...
    private void viewBankAccountDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewBankAccountDetailsActionPerformed
        ViewClaimsAccountDetailsJPanel accountDetails = new ViewClaimsAccountDetailsJPanel(userProcessContainer, userAccount, organization, enterprise);
        userProcessContainer.add("ViewClaimsAccountDetailsJPanel", accountDetails);
    ...
    private void newAccountReqBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_newAccountReqBtnActionPerformed
           CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("ViewBankAccountRequest", new ViewClaimsAccountRequest(userProcessContainer, userAccount, organization,enterprise));
        layout.next(userProcessContainer);
  ...
  CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("ViewLoanApplicationWorkAreaJPanel", new ViewClaimsApplicationWorkAreaJPanel(userProcessContainer, userAccount, enterprise));
        layout.next(userProcessContainer);
