...
public class ViewClaimsApplicationWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public ViewClaimsApplicationWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Enterprise enterprise) {
        initComponents();
    ...
    public void populateRequestTable(){
        ...
        model.setRowCount(0);
        for (ResponderToClaims request : enterprise.getWorkQueue().getResponderToClaim()){
            Object[] row = new Object[5];
            row[0] = request;
            row[1] = request.getLoan().getReen();
            row[2] = request.getLoan().getFunds();
            row[3] = request.getStatus();
            row[4] = request.getResponder().getClaimsAmountApproved();
    ...
    private void viewRespondersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewRespondersActionPerformed
        ...
        if (selectedRow < 0){
            ...
            ResponderToClaims request = (ResponderToClaims)workRequestJTable.getValueAt(selectedRow,0);
            if(request.getStatus().equals("Pending")){
                request.setStatus("Processing");
                request.setReceiver(userAccount);
                CardLayout layout = (CardLayout) userProcessContainer.getLayout();
                userProcessContainer.add("ViewClaimsReq", new ViewClaimsRequest(userProcessContainer, userAccount, request, enterprise));
                layout.next(userProcessContainer);
            }
            else{
                JOptionPane.showMessageDialog(null, "Claims request completed");
                return;
