...
public class VolunteersRequestWorkAreaJPanel extends javax.swing.JPanel {
     ...
     * Creates new form 
     */
    public VolunteersRequestWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise) {
        initComponents();
   ...
   // public void populateRequestTable(){
    ...
    public void popRequestTable(){
        DefaultTableModel model = (DefaultTableModel) workRequestJTable.getModel();
        
        model.setRowCount(0);
        for (VolunteerToClaimManagr request : enterprise.getWorkQueue().getVolunteerToClaim()){
            Object[] row = new Object[4];
            row[0] = request;
            row[1] = request.getVolunteer().getEmail();
    ...
    private void btnViewApplicationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewApplicationActionPerformed
        ...
        VolunteerToClaimManagr request = (VolunteerToClaimManagr)workRequestJTable.getValueAt(selectedRow, 0);
        ...
        if(request.getRequestResult().equals("")){
            ...
            userProcessContainer.add("ViewVolunteersApp", new ViewVolunteersApplication(userProcessContainer, request, userAccount, enterprise));
