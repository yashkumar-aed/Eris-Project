...
public class RespondersRequestWorkAreaJPanel extends javax.swing.JPanel {
   ...
   public RespondersRequestWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise) {
        initComponents();
       ...
       public void populateRequestTable(){
        ...
        model.setRowCount(0);
        for (RespondersToClaimsManager request : enterprise.getWorkQueue().getResponderToClaimManagr()){
            if(request.getClaimmanagr().getName().equals(account.getClaimmanagr().getName())){
            Object[] row = new Object[5];
            row[0] = request;
            row[1] = request.getMessage();
            row[2] = request.getRespondeer().getUsername();
            row[3] = request.getStatus();
            UserAccount result = ((RespondersToClaimsManager) request).getReceiver();
    ...
    private void viewRespondersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewRespondersActionPerformed
       int selectedRow = workRequestJTable.getSelectedRow();
        ...
        else
        {
            ...
            userProcessContainer.add("ViewResponders", new ViewRespondersJPanel(userProcessContainer, request, account, enterprise));
