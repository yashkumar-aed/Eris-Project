...
public class NFRFInsuranceManagerWorkAreaJPanel extends javax.swing.JPanel {
  ...
  private JPanel userProcessContainer;
    ...
    public NFRFInsuranceManagerWorkAreaJPanel(JPanel userProcessContainer, Enterprise enterprise, UserAccount account) {
        initComponents();
    ...
    public void populateRequestTable(){
        ...
        model.setRowCount(0);
        for (ResponderToNFRFInsurance request : enterprise.getWorkQueue().getResponderToNFRFInsurance()){
            Object[] row = new Object[4];
            row[0] = request;
            row[1] = request.getInsurance().getBranch();
    ...
    private void viewRespondersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewRespondersActionPerformed
      int selectedRow = workRequestJTable.getSelectedRow();
        ...
        if (selectedRow < 0){
            ...
            ResponderToNFRFInsurance request = (ResponderToNFRFInsurance)workRequestJTable.getValueAt(selectedRow,0);
