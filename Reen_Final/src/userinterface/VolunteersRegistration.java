...
public class VolunteersRegistration extends javax.swing.JPanel {
    ...
    private VolunteerToClaimManagr volunteerToClaim;
    private Enterprise enterprise;
    private Organization organization;
   
    
    public VolunteersRegistration(JPanel userProcessContainer, EcoSystem system) {
        initComponents();
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
       ...
       ReenEnterprise reenen = (ReenEnterprise) branchJComboBox.getSelectedItem();
        ...
        for (Network n : system.getNetworkList()){
          ...
          Volunteers volun = new Volunteers(username, email, password);
        reenen.getVolunteerDirectory().addVolunteer(volun);
        volunteerToClaim = new VolunteerToClaimManagr("Please review the volunteer", volun);
        reenen.getWorkQueue().getVolunteerToClaim().add(volunteerToClaim);
        
        JOptionPane.showMessageDialog(null, "Account Registered Successfully. Account sent to Claims Manager for Approval");
