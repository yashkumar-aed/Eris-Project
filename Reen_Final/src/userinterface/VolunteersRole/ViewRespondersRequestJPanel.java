...
public class ViewRespondersRequestJPanel extends javax.swing.JPanel {
    ...
    private UserAccount claimsManagerAccount;
    private EcoSystem system;
 
    public ViewRespondersRequestJPanel(JPanel userProcessContainer, UserAccount userAccount, Organization organization, Enterprise enterprise, EcoSystem system) {
        initComponents();
    ...
    public void populateRequestTable(){
        ...
        model.setRowCount(0);
        for (ResponderToVolunteer bm : enterprise.getWorkQueue().getResponderToVolunteer()){
            if(bm.getVolunteer().equals(userAccount.getVolunteer())){
            Object[] row = new Object[3];
            row[0] = bm;
            row[1] = bm.getResponder().getEmailId();
            
            row[2] = bm.getResponder().getClaimsmanagr();
   ...
   int selectedRow = workRequestJTable.getSelectedRow();
        ...
        ResponderToVolunteer request = (ResponderToVolunteer) workRequestJTable.getValueAt(selectedRow, 0);

        CardLayout layout = (CardLayout) userProcessContainer.getLayout();
        userProcessContainer.add("ViewResProfile", new ViewRespondersProfile(userProcessContainer, userAccount, request));
